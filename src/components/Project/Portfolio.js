    ...
    <>
      <div className="title container"><h1>Claude Mokbel</h1>
        <p>A recent graduate of the UCI Continued Education Full Stack Web Developer bootcamp.
          I have 7 months of experience building web applications in HTML, CSS, and Javascript with mobile responsivity.
          I am currently focused on honing my skills in React.js, learning patterns as well as algorithms,
          and database functionality in web applications.
        </p>
      </div>
